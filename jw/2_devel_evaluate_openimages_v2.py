...
if __name__ == '__main__':
    print(opt)
    opt.save_path = "/root/14_zsl/jw/results/220302_openimages/model_latest_1100_10.pth"
    ...
    for i, batch_data in enumerate(tqdm(test_loader)):
        ...
        with torch.no_grad():
            ...
            logits_7186 = model_test(batch_features, vecs_7186, vgg_4096)
            logits_400 = model_test(batch_features, vecs_400, vgg_4096)
            logits_7586  = model_test(batch_features, gzsl_vecs, vgg_4096) ##seen-unseen
