...
for model_path in paths:
    ...
    for data_index in range(200):
        # data_index = 1
        map_lab, map_prediction, map_img_name = map_lab_7186[data_index, :], map_prediction_7186[data_index, :], map_image_names[data_index]
        num_k = 10
        img_path = os.path.join("/root/jwssd/datasets/OpenImages/test", map_image_names[data_index])
        img = Image.open(img_path)
        img_new = VisClassSeenTopK(map_lab, map_prediction, img, map_seen_labelmap, label_dict, num_k)
        img_new.save(f"figures/220217/{data_index}.png")
